...
TRANSLATIONS = {
    "zh-Hant": {
        ...
        "hero.title": "課程影片字幕整理與複習輔助系統",
        "hero.intro": "本系統可協助學生將課程影片轉換為字幕與文字稿，並建立學習筆記與複習重點，提高學習效率。",
        "lang.label": "語言",
        "lang.zh-Hant": "繁中",
        "lang.zh-Hans": "简中",
        "lang.en": "English",
...
def stt_upload_job(source_path: Path, model: str) -> tuple[int, dict[str, Any]]:
    try:
        ...
        txt_filename = f"{source_path.stem}.txt"
...
def upload_course():
    ...
    title = request.form.get("title", "未命名課程")
...
@app.delete("/api/course/<int:course_id>")
def delete_course(course_id):
